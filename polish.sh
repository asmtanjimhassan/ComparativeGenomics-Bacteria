...
read1=$currdir/trimmed_reads/target_R1.fastq.gz
read2=$currdir/trimmed_reads/target_R2.fastq.gz  
...
cp $currdir/target_SPADES_OUT/scaffolds.fasta ./raw_assembly.fasta
...
cp pilon_stage4.fasta ../polished_assembly/target.polished.fasta
cd ../
